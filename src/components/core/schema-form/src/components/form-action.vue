  ...
  <Col v-if="showActionButtonGroup" v-bind="actionColOpt">
    <div style="width: 100%" :style="{ textAlign: actionColOpt.style.textAlign }">
      <Form.Item>
        ...
        <Button v-if="showResetButton" type="default" class="mr-2" v-bind="getResetBtnOptions" @click="resetFields">
          {{ getResetBtnOptions.text }}
        </Button>
        <slot name="submitBefore"></slot>

        <Button v-if="showSubmitButton" type="primary" class="mr-2" v-bind="getSubmitBtnOptions" @click="submit">
...
import { BasicArrow } from '@/components/common/basic-arrow';
