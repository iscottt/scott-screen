...
import type { ButtonProps as AntdButtonProps } from '@/components/common/button';
import type { ColEx, ComponentProps } from './component';
...
/** 自定义VNode渲染器 */
export type CustomRenderFn<T = any> = (renderCallbackParams: RenderCallbackParams<T>) => VNode | VNode[] | string;
